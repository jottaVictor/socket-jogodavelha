...
var _Sala_id, _Sala_configuracaoSala, _Sala_jogadores, _Sala_placar, _Sala_registroPartidas, _Sala_partidaAtual;
...
class Sala {
    ...
    setDono(jogador) {
        const newConfig = new ConfiguracaoSala_1.default(__classPrivateFieldGet(this, _Sala_configuracaoSala, "f").nomeSala, __classPrivateFieldGet(this, _Sala_configuracaoSala, "f").senha, jogador.id, __classPrivateFieldGet(this, _Sala_configuracaoSala, "f").capacidadeMax);
    ...
    estaCheia() {
        return this.countJogadores() == __classPrivateFieldGet(this, _Sala_configuracaoSala, "f").capacidadeMax;
    }
...
_Sala_id = new WeakMap(), _Sala_configuracaoSala = new WeakMap(), _Sala_jogadores = new WeakMap(), _Sala_placar = new WeakMap(), _Sala_registroPartidas = new WeakMap(), _Sala_partidaAtual = new WeakMap();
