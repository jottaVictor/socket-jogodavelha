...
var _ConfiguracaoSala_nomeSala, _ConfiguracaoSala_senha, _ConfiguracaoSala_idDono, _ConfiguracaoSala_maxJogadores;
...
class ConfiguracaoSala {
    ...
    get maxJogadores() {
        return __classPrivateFieldGet(this, _ConfiguracaoSala_maxJogadores, "f");
    }
    constructor(nomeSala, senha, idDono, maxJogadores) {
        ...
        _ConfiguracaoSala_maxJogadores.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _ConfiguracaoSala_maxJogadores, maxJogadores, "f");
    }
    publica() {
        return __classPrivateFieldGet(this, _ConfiguracaoSala_senha, "f").length > 0;
    }
}
_ConfiguracaoSala_nomeSala = new WeakMap(), _ConfiguracaoSala_senha = new WeakMap(), _ConfiguracaoSala_idDono = new WeakMap(), _ConfiguracaoSala_maxJogadores = new WeakMap();
